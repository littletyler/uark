...
<div class="row" style="display: grid;width:1600px;">
<div id="chart-container" class="col-6">
        <p class="text-center" style="color:white;">Customer Signups by Day</p>
			<canvas id="mycanvas2" class="col-10 mx-auto" style="background-color:white;"></canvas>
		</div>

<div id="chart-container" class="col-6">
        <p class="text-center" style="color:white;">Rentals by Day</p>
			<canvas id="mycanvas" class="col-10 mx-auto" style="background-color:white;"></canvas>
		</div>
