...
$(document).ready(function(){
    ...
    <title>TEAM TYLER - UARK
    </title>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js">
    </script>
    <script type="text/javascript" src="https://use.fontawesome.com/9efafc294b.js">
    </script>
    ...
    <div class="side" style="float:left;">
      <nav class="dr-menu">
        <div class="dr-trigger">
          <span class="dr-icon dr-icon-menu">
          </span>
          <a class="dr-label">EyeFly
          </a>
        </div>
        <ul>
          <li>
            <a class="dr-icon dr-icon-user" href="#">Account
            </a>
          </li>
          <li>
            <a class="dr-icon fa-dropbox" href="/uark/inventory.php">Inventory
            </a>
          </li>
          <li>
            <a class="dr-icon fa-shopping-cart" href="#">Transaction
            </a>
          </li>
          <li>
            <a class="dr-icon fa-list" href="#">Reports
            </a>
          </li>
          <li>
            <a class="dr-icon fa-area-chart" href="/uark/metrics.php">Metrics
            </a>
          </li>
          <li>
            <a class="dr-icon fa-sign-out" href="/uark/logout.php">Logout
            </a>
          </li>
        </ul>
      </nav>
...
<div class="container" id="main" style="width: 70%;position: absolute;padding-right: 15%;padding-left: 15%;">
  <h2>
    <?php echo $sqltable . ' View'; ?>
    </h1>
  <table id="myTable">
    <tr>
      <th>
        <h1>
          <?php echo $sqltable; ?> ID
        </h1>
      </th>
      <th>
        <h1>Full Name
      ...
      <th>
        <h1 style="text-align: center;">Remove?
        </h1>
      </th>
    </tr>
    <?php
...
echo "<tr>";
echo "<td class='input'>" . $table_name[$sqltable.'ID'] . "</td>";
echo "<td class='input' style='text-align:left;'>" . $table_name['FirstName'] ." ".$table_name['LastName'] . "</td>";
echo "<td class='input' style='text-align:right; padding-right:30px'>"  . $table_name['FirstName'] ."</td>";
echo "<td class='input' style='text-align:left;'> ".$table_name['LastName'] ."</td>";
echo "<td class='input' style='text-align:center;'><a class='delete btn btn-danger' href='delete.php?del=" .$table_name[$sqltable.'ID']."'onclick='return yes('Are you sure you want to remove this?')'><i class='fa fa-ban' aria-hidden='true'></i></a>";
echo "<tr>";
}//end loop
?> 
  </table>
  <form action="insert_ac.php" id="loginform" method="post" name="loginform">
    ...
    <input style="width:30%;" class="input"  id="name" name="name" type="text"> 
    <input style="width:30%;" class="input" id="lastname" name="lastname" type="text">
