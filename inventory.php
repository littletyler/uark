...
">
    ...
    <div id="papage-content-wrapper">
        ...
        <div class="col-10 mx-auto">
            <div class="table-responsive" style="display: block;width: 100%;overflow-x: auto;background-color: #ffff;opacity: .9;padding-right: 20px;padding-left: 20px;border-radius: 10px;padding-bottom: 5px;padding-top: 5px;">


<?php
$res=mysql_query("Select count(distinct Rental_ID) as count From Rental Where (Date_Returned is null) AND (Date_Due < CURDATE())");
$res2=mysql_query("Select * From Rental Where (Date_Returned is null) AND (Date_Due < CURDATE())");
while($row=mysql_fetch_array($res))
{
    //table rows
    echo "<p>Total Overdue Items: ". $row["count"] . "";
}
?>
...
{
    //table rows
    echo "<tr><td class='table-dark'>". $row2["Date_Rented"] . "</td><td>".$row2["Date_Due"]."</td></tr>";
}
?>
</table>
		...
		<div class="modal" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="add-modal-label">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		    	<form class="form-horizontal" id="add-form">
			      ...
			      <div class="modal-body">
			        	<div class="form-group">
					    	...
					    	<div class="col-sm-10">
					      		<input type="text" class="form-control" id="add-id" name="id" placeholder="id">
					    	</div>
					  	</div>
					  	<div class="form-group">
